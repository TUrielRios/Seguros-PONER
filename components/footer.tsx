      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <a
                href="#"
                aria-label="Facebook"
                className="flex size-9 items-center justify-center rounded-full bg-background/10 text-background/60 transition-colors hover:bg-primary hover:text-primary-foreground"
              >
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-center md:flex-row">
          <p className="text-sm text-background/40">
            {`© ${new Date().getFullYear()} Poner Seguros. Todos los derechos reservados.`}
          </p>
